...
export default function CallDestinationSettings({
                                                    numberData,
                                                    formData,
                                                    onInputChangeAction,
                                                    formErrors
                                                }:
                                                CallDestinationSettingsProps) {
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <Input
                            ...
                            onChange={(e) => onInputChangeAction('call_destination', e.target.value)}
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            onChange={(e) => onInputChangeAction('call_priority', e.target.value ? parseInt(e.target.value) : null)}
                    ...
                    <div>
                        ...
                        <Input
                            ...
                            onChange={(e) => onInputChangeAction('follow_droid_caller_id', e.target.value)}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-4">
                    <div className="flex items-center space-x-2">
                        <Checkbox
                            ...
                            onCheckedChange={(checked) => onInputChangeAction('call_activated', checked)}
                        />
                    ...
                    <div className="flex items-center space-x-2">
                        <Checkbox
                            ...
                            onCheckedChange={(checked) => onInputChangeAction('voip_call', checked)}
                        />
                    ...
                    <div className="flex items-center space-x-2">
                        <Checkbox
                            ...
                            onCheckedChange={(checked) => onInputChangeAction('call_show_real_caller_id', checked)}
                        />
