...
export default function LanguageSelector({
    ...
    // Initialize with all languages selected only once at the start
    const initializedRef = useRef(false)
    useEffect(() => {
        if (languages.length > 0 && !initializedRef.current) {
    ...
    useEffect(() => {
        ...
        // Only update allSelected state when selectedLanguages changes due to individual language toggles
        // This prevents the "All" button from flickering when it's manually toggled
