...
>(({className, ...props}, ref) => (
    <thead ref={ref} className={cn('[&_tr]:border-b [&_tr]:border-border/25', className)} {...props} />
))
...
>(({className, divide = true, ...props}, ref) => (
    <tbody
        ref={ref}
        className={cn(divide && 'divide-y divide-border/25', className)}
        {...props}
    />
))
