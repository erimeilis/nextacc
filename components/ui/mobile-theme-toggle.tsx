    ...
    return (
        <div className="flex flex-col items-center">
            <div className="flex items-center gap-2">
                ...
                >
                    <SunIcon className="h-5 w-5 rotate-0 scale-100 transition-all dark:rotate-90 dark:scale-0 dark:text-white text-black"/>
                    <MoonIcon className="absolute h-5 w-5 rotate-90 scale-0 transition-all dark:rotate-0 dark:scale-100 dark:text-white text-black"/>
                ...
                <DropdownMenu open={isThemeMenuOpen} onOpenChange={setIsThemeMenuOpen}>
                    <DropdownMenuTrigger asChild>
                        <Button
                            ...
                            className="rounded-lg p-2.5 text-sm"
                        >
                            <PaletteIcon className="h-5 w-5 dark:text-white text-black"/>
                            <span className="sr-only">Toggle color theme</span>
                        </Button>
                    </DropdownMenuTrigger>
                    <DropdownMenuContent
                        className="w-56 z-[10000] shadow-sm shadow-mute dark:shadow-black"
                        align="center"
                        forceMount
                    >
