...
export default function Component() {
    ...
    if (session) {
        return (
            <div className="flex items-center justify-between text-gray-800 dark:text-indigo-200 w-full bg-gray-50 dark:bg-indigo-800 p-10 rounded-md">
                <div>{dictionary['login'].signed_in_as} {session.user.email}</div>
    ...
    return (
        <div className="text-gray-800 dark:text-indigo-200 w-full bg-gray-50 dark:bg-indigo-800 p-10 rounded-md">
